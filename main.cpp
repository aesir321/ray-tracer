...
void renderSceneOne()
{
	...
	Shape *sphere = new Sphere(spherePos, 5, 0.2, 0.2, shininess, RGBColour(0, 255, 0));
	scene.Populate(sphere);

	Vector spherePos2(0, 0, 100);
	Shape *sphere2 = new Sphere(spherePos2, 15, diffuseCoeffcient, 0.4, shininess, RGBColour(255, 0, 0));
	scene.Populate(sphere2);

	Vector spherePos3(20, 10, 80);
	Shape *sphere3 = new Sphere(spherePos3, 5, diffuseCoeffcient, 0.6, shininess, RGBColour(0, 0, 255));
...
void renderSceneTwo()
{
	...
	Shape *sphere = new Sphere(spherePos, 5, 0.3, 0.4, 150, RGBColour(0, 255, 0));
	scene.Populate(sphere);

	Vector spherePos2(0, 3, 20);
	Shape *sphere2 = new Sphere(spherePos2, 2, 0.6, 0.8, 60,RGBColour(54, 218, 251));
	scene.Populate(sphere2);

	Vector spherePos3(5, 0, 60);
	Shape *sphere3 = new Sphere(spherePos3, 5, 0.8, 0.2, 90, RGBColour(250, 142, 241));
	scene.Populate(sphere3);

	Vector planeNormal(0, 0, 1);
	RGBColour planeColour(0, 255, 255);
	Shape *plane = new Plane(planeNormal, planeColour, 102, 0.6, 0.1, 0.9);
	scene.Populate(plane);

	Vector planeNormal1(0, 1, 0);
	RGBColour planeColour1(200, 200, 200);
	Shape *plane1 = new Plane(planeNormal1, planeColour1, 11, 0.4, 0.1, 0.9);
...
void renderSceneThree()
{
	...
	Shape *sphere = new Sphere(spherePos, 5, diffuseCoeffcient, reflectiveCoefficient, shininess, RGBColour(255, 0, 0));
	scene.Populate(sphere);

	Vector spherePos2(5, -5, 80);
	Shape *sphere2 = new Sphere(spherePos2, 5, diffuseCoeffcient, reflectiveCoefficient, shininess, RGBColour(0, 255, 0));
	scene.Populate(sphere2);

	Vector spherePos3(0, 4, 100);
	Shape *sphere3 = new Sphere(spherePos3, 5, diffuseCoeffcient, reflectiveCoefficient, shininess, RGBColour(0, 0, 255));
	scene.Populate(sphere3);

	Vector spherePos4(-10, 3.5, 80);
	Shape *sphere4 = new Sphere(spherePos4, 5, diffuseCoeffcient, reflectiveCoefficient, shininess, RGBColour(0, 255, 255));
	...
	Shape *sphere6 = new Sphere(spherePos6, 5, diffuseCoeffcient, reflectiveCoefficient, shininess, RGBColour(255, 145, 0));
	scene.Populate(sphere6);

	Vector spherePos7(5, 12, 80);
	Shape *sphere7 = new Sphere(spherePos7, 5, diffuseCoeffcient, reflectiveCoefficient, shininess, RGBColour(255, 0, 255));
